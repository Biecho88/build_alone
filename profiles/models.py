...
class UserProfile(models.Model):
    ...
    default_phone_number = models.IntegerField(max_digits=11, null=True, blank=True)
    ...
    default_town_or_city = models.CharField(max_length=15, null=True, blank=True)
    default_county = models.CharField(max_length=15, null=True, blank=True)
